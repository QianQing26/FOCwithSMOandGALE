...
// Add just for test
#define MAI_SENSORED_SPEED			   ((115 << ELT_IDENTIFIER_POS) | TYPE_DATA_16BIT )
#define HUANG_FILTERED_SPEED		   ((116 << ELT_IDENTIFIER_POS) | TYPE_DATA_16BIT )
#define LMMAE_SPEED					   ((117 << ELT_IDENTIFIER_POS) | TYPE_DATA_16BIT )
#define SMO_SPEED					   ((118 << ELT_IDENTIFIER_POS) | TYPE_DATA_16BIT )
