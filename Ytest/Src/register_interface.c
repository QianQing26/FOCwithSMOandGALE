    ...
    { //cstat !MISRAC2012-Rule-16.1
      ...
      case TYPE_DATA_16BIT:
      {
        ...
        switch (regID)
        {
          ...
          case MAI_SENSORED_SPEED:
          {
        	retVal = MCP_ERROR_RO_REG;
        	break;
          }

          case HUANG_FILTERED_SPEED:
          {
        	  retVal = MCP_ERROR_RO_REG;
        	  break;
          }
  ...
  else
  {
    ...
    switch (typeID)
    {
      case TYPE_DATA_16BIT:
      {
        ...
        case MAI_SENSORED_SPEED:
        {
//        	*dataPtr = &((pMCIN->pSTC)[M1]->SPD->hAvrMecSpeedUnit);
        ...
        case HUANG_FILTERED_SPEED:
        {
        	*dataPtr = & (gSpeedFilter.speed_int16);
        	break;
        }
        ...
        case SMO_SPEED:
        {
//        	*dataPtr = & (gSMO.InstantaneousElSpeedDpp);
        	*dataPtr = & (gSMO.Speed);
        }
